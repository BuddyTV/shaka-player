...
shaka.hls.ManifestTextParser = class {
   ...
   */
  parsePlaylistMain(data, absolutePlaylistUri, tv) {
    ...
    for (let i = 0; i < lines.length; i++) {
      ...
      if (SEGMENT_TAGS.includes(tag.name) && (width > 700 && width < 1200)) {
